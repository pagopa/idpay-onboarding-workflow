...
@EmbeddedKafka(topics = {
        ...
        "${spring.cloud.stream.bindings.consumerCommand-in-0.destination}",
...
@TestPropertySource(
        properties = {
                ...
                "spring.cloud.stream.binders.kafka-command.environment.spring.cloud.stream.kafka.binder.brokers=${spring.embedded.kafka.brokers}",
                //endregion
