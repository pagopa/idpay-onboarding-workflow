...
public final class OnboardingWorkflowConstants {
  ...
  public static final String REGISTERED_NOT_REFUNDABLE = "REGISTERED_NOT_REFUNDABLE";
  public static final String REGISTERED_ONLY_IBAN = "REGISTERED_ONLY_IBAN";
  public static final String REGISTERED_ONLY_CC = "REGISTERED_ONLY_CC";
